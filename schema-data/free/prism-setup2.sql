...
PROMPT
PROMPT  Next steps:
PROMPT    1. Run: python prism-seed.py              (load sample data)
PROMPT    2. Run: python prism-chunks-import.py     (import vector data)
PROMPT    3. Run: @prism-indexes.sql                (create vector index)
PROMPT ============================================================================
PROMPT